...
with open('Round 4/data.csv', newline='') as csvfile:
    ...
    for row in reader:
        ...
        message = ("Hi " + row['First Name'] + 
              ...
              " days overdue. This is the final notice for you to return the " + row['Title'] + "\n\n" +

              "Failure to return this item by May 10, 2024 will result in a replacement fee equivalent to the cost of the item, on your student account.\n\n" +
