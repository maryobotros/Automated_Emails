...
with open('Tia_R2/tia_students_data.csv', newline='') as csvfile:
    ...
    for row in reader:
        ...
        message = ("Dear " + row['First Name'] + row['Last Name'] +
              ...
              " days overdue. Please bring " + row['Title']+ " back before May 3, 2024.  If you do not return the book, we will consider the book lost," +
              " and any replacement fees will be charged to your student account.\n\n" +
        ...
        server.login(email,  "bgsh ohuo jvan zgjc")
